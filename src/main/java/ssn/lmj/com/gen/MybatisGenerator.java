...
//            System.out.println(m.group(0));
    ...
    private static List<MapperMethod> getInterfaceMapperMetthods(Class clazz) {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            SSNMapper mapper = md.getAnnotation(SSNMapper.class);
            if (mapper == null) {
                continue;
            }
...
//                e.printStackTrace();
        ...
        imports.put("ssn.lmj.com.dao.SSNTableDAO","import ssn.lmj.com.dao.SSNTableDAO;");
        String dobj = packageName + ".dobj." + className + "DO";
        imports.put(dobj,"import " + dobj + ";");
        imports.put("org.apache.ibatis.annotations.Mapper","import org.apache.ibatis.annotations.Mapper;");
