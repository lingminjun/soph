...
public interface SPermissionRoleIndexQueryDAO extends TableDAO<SPermissionRoleDO> { 
     ...
     * @return
     */
    public List<SPermissionRoleDO> queryByDomain(@Param("domain") String domain, @Param("isDelete") int isDelete,@Param("sortField") String sortField,@Param("isDesc") boolean isDesc,@Param("offset") int offset,@Param("limit") int limit);
