...
public interface SUserExtIndexQueryDAO extends TableDAO<SUserExtDO> { 
     ...
     * @return
     */
    public List<SUserExtDO> queryByUid(@Param("uid") long uid, @Param("isDelete") int isDelete,@Param("sortField") String sortField,@Param("isDesc") boolean isDesc,@Param("offset") int offset,@Param("limit") int limit);
     ...
     * @return
     */
    public List<SUserExtDO> queryByUidAndDataType(@Param("uid") long uid, @Param("dataType") String dataType, @Param("isDelete") int isDelete,@Param("sortField") String sortField,@Param("isDesc") boolean isDesc,@Param("offset") int offset,@Param("limit") int limit);
