...
CREATE TABLE IF NOT EXISTS `s_account` (
  `id`  bigint NOT NULL AUTO_INCREMENT ,
  `platform`  varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '平台|大陆手机号(China mobile)|邮箱账号',
  `open_id`  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '开放平台id|+86-15673886363|soulshangm@gmail.com' ,
